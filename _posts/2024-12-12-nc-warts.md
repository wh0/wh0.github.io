...
You don't want (1) to happen, so suppose you set `O_NONBLOCK` on your stdout.

All this on paper threatens to put you into a livelock where `write` could keep telling you to try again while `select` keeps telling you that you can write.
(4) might help, but you might not have collected enough bytes from the socket.
...
[**netcat6**](https://www.deepspace6.net/projects/netcat6.html) is a reimplementation of netcat.
