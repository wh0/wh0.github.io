...
qualitative_time: 
title: Glitter text
previous_teaser: How to keep the corners clothing tags nice and sharp
previous_first: true
---
...
1. "Diffuse" reflection--which makes a surface brighter when they're facing the
...
compression, which was something you didn't have back when you were choosing
between JPEG and GIF.
...
Anyway, a few filter primitives that don't take in an input image, which you
can use as a starting point when you don't already have an image to start with.
